...
from .shared import AnswerMessage, ContactPhone, UnpinMessage
from .shared import BackgroundGradient as SharedBackgroundGradient
from .shared import TextAttachment as SharedTextAttachment
...
__all__ = [
    ...
    "SharedBackgroundGradient",
    "SharedContact",
    "SharedTextAttachment",
    "Sticker",
    "StoryContext",
    "StoryMessage",
