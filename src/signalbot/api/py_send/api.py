...
from .shared.api import RemoteDeleteResponse, SetPinRequest, TrustModeRequest
...
class SendMessageResponse(RemoteDeleteResponse):
    pass
...
class TrustModeResponse(TrustModeRequest):
    pass
...
class VerifyNumberSettings(SetPinRequest):
    pass
